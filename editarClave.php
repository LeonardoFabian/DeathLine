...
<body>
 ...
 <section id="subcontent" class=" ">              
        <form id="editarUsuario" action="procesarEditarUsuario.php" method="POST" class="login_tutor_formulario" style="width:400px;margin:0 auto;">
                ...
                <h1 id="" style="text-align:left" class="">Cambiar contraseña</h1>                            
            
            <fieldset id="inputs" style="border:none;">
                <input type="hidden" name="id" value="<?php echo $datos['id']; ?>" />
                <p>
                   <!-- <label for="claveActual" class="label">Contraseña actual</label><br/>-->
                    <input type="password" name="claveActual" id="claveActual" class="inputs" autofocus  placeholder="Contraseña actual" required/>
                </p>
                <p>
                  <!--  <label for="claveNueva" class="label">Nueva contraseña</label><br/>-->
                    <input type="password" name="claveNueva" id="claveNueva" class="inputs" autofocus  placeholder="Nueva contraseña" required/>
                </p>
                <p>
                   <!-- <label for="claveConfirmar" class="label">Confirmar contraseña</label><br/>--
                    <input type="password" name="claveConfirmar" id="claveConfirmar" class="inputs" autofocus  placeholder="Confirmar contraseña" required/>
                </p>-->
